...
let ctrl : QzmjSwitchCardWithWallGmCtrl;
//模型，数据处理
...
//c, 控制
@ccclass
export default class QzmjSwitchCardWithWallGmCtrl extends BaseCtrl {
	//这边去声明ui组件
	@property({
		tooltip : "我方的麻将位置",
		type : cc.Node
	...
	emitChangeCard () : void {
		if (this.model.handCard != null && this.model.oppositeCard != null) {
			...
			// let s = new cc.SpriteFrame(this.model.mahjongResMgr.getInstance().getCardTextureByValue(this.model.oppositeCard));
