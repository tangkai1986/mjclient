...
import LymjCards from "../LymjMgr/LymjCards";
...
//c, 控制
@ccclass
export default class LymjRoomCtrl extends BaseCtrl {
	//这边去声明ui组件   
	//声明ui组件end
	...
	onLoad (){
		...
		//在这里先生成对象，否则怕监听不到数据
		RoomMgr.getInstance().setGameLibs(MahjongDef,MahjongResMgr,LymjLogic,MahjongAudio,LymjCards);  
