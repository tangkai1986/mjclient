...
//c, 控制
@ccclass
export default class Bull_totalSettleCtrl extends BaseCtrl {
	view:View = null
    model:Model = null
    ...
    private clickOpenDetail(event){
        ...
        if(curNode[CONFIGS.str_openNode]){
            ...
            // //console.log('click clickOpenDetail index= ',curNode[CONFIGS.str_diyIndex], this)
    ...
    onDestroy(){
        BunchInfoMgr.getInstance().resetData();
        super.onDestroy();
    }
}