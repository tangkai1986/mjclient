...
class View extends BaseView{
    ...
    initViewWithRounds()
    {
        ...
        let LymjRounds = cc.instantiate(this.ui.prefab_LymjRoundsSettle);
        this.ui.node_content.addChild(LymjRounds);
        let LymjRoundsCtrl = LymjRounds.getComponent("LymjRoundsSettleCtrl");
    ...
    {
        this.ui.node_content.removeAllChildren();
        let LymjStatistics = cc.instantiate(this.ui.prefab_LymjStatisticsSettle);
        let LymjStatisticsSettleCtrl = LymjStatistics.getComponent("LymjStatisticsSettleCtrl");
...
//c, 控制
@ccclass
export default class LymjFinalSettleCtrl extends BaseCtrl {
    //这边去声明ui组件
    @property({
        tooltip : "content",
        type : cc.Node
    ...
    prefab_LymjRoundsSettle : cc.Prefab = null;
    @property({
        tooltip : "总统计",
        type : cc.Prefab
    })
    prefab_LymjStatisticsSettle : cc.Prefab = null;
    @property({
        tooltip : "btn_close",
        type : cc.Node
    })
