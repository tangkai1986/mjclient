...
class View extends BaseView{
    ...
    initViewWithRounds()
    {
        ...
        let FzmjRounds = cc.instantiate(this.ui.prefab_FzmjRoundsSettle);
        this.ui.node_content.addChild(FzmjRounds);
        let FzmjRoundsCtrl = FzmjRounds.getComponent("FzmjRoundsSettleCtrl");
    ...
    {
        this.ui.node_content.removeAllChildren();
        let FzmjStatistics = cc.instantiate(this.ui.prefab_FzmjStatisticsSettle);
        let FzmjStatisticsSettleCtrl = FzmjStatistics.getComponent("FzmjStatisticsSettleCtrl");
...
//c, 控制
@ccclass
export default class FzmjFinalSettleCtrl extends BaseCtrl {
    //这边去声明ui组件
    @property({
        tooltip : "content",
        type : cc.Node
    ...
    prefab_FzmjRoundsSettle : cc.Prefab = null;
    @property({
        tooltip : "总统计",
        type : cc.Prefab
    })
    prefab_FzmjStatisticsSettle : cc.Prefab = null;
    @property({
        tooltip : "btn_close",
        type : cc.Node
    })
